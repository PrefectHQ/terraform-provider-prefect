		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testutils.TestCheckJSONAttr(eventTriggerAutomationResourceNameAndPath, "actions.0.parameters", `{"param1":"value1","param2":"value2"}`),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testutils.TestCheckJSONAttr(metricTriggerAutomationResourceNameAndPath, "trigger.metric.match", `{"prefect.resource.id":"prefect.flow-run.*"}`),
					testutils.TestCheckJSONAttr(metricTriggerAutomationResourceNameAndPath, "trigger.metric.match_related", `{"prefect.resource.id":"prefect.flow-run.*","prefect.resource.role":"flow"}`),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testutils.TestCheckJSONAttr(compoundTriggerAutomationResourceNameAndPath, "trigger.compound.triggers.1.event.match_related", `{"prefect.resource.id":"prefect.flow-run.*","prefect.resource.role":"flow"}`),
					...
					testutils.TestCheckJSONAttr(compoundTriggerAutomationResourceNameAndPath, "actions.0.job_variables", `{"var1":"value1","var2":"value2","var3":"value3"}`),
				),
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testutils.TestCheckJSONAttr(sequenceTriggerAutomationResourceNameAndPath, "trigger.sequence.triggers.0.event.match", `{"prefect.resource.id":"prefect.flow-run.*"}`),
					testutils.TestCheckJSONAttr(sequenceTriggerAutomationResourceNameAndPath, "trigger.sequence.triggers.0.event.match_related", `{}`),
					...
					testutils.TestCheckJSONAttr(sequenceTriggerAutomationResourceNameAndPath, "trigger.sequence.triggers.1.event.match", `{"prefect.resource.id":"prefect.flow-run.*"}`),
					testutils.TestCheckJSONAttr(sequenceTriggerAutomationResourceNameAndPath, "trigger.sequence.triggers.1.event.match_related", `{"prefect.resource.id":["prefect.flow.ce6ec0c9-4b51-483b-a776-43c085b6c4f8"],"prefect.resource.role":"flow"}`),
					...
					testutils.TestCheckJSONAttr(sequenceTriggerAutomationResourceNameAndPath, "trigger.sequence.triggers.2.event.match", `{"prefect.resource.id":"prefect.flow-run.*"}`),
					testutils.TestCheckJSONAttr(sequenceTriggerAutomationResourceNameAndPath, "trigger.sequence.triggers.2.event.match_related", `{"prefect.resource.id":["prefect.flow-run.*"],"prefect.resource.role":"flow"}`),
