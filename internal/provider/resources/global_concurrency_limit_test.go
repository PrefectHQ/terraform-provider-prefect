		...
		Steps: []resource.TestStep{
			{
				...
				Config: fixtureAccGlobalConcurrencyLimitCreate(workspace.Resource, "test1", 10, true, 0, 1, 1.5),
			...
			{
				Config: fixtureAccGlobalConcurrencyLimitCreate(workspace.Resource, "test2", 20, false, 1, 1, 2),
				Check: resource.ComposeAggregateTestCheckFunc(
