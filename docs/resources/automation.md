...
```terraform
import {
  to = prefect_automation.example
  id = "00000000-0000-0000-0000-000000000000"
}

resource "prefect_automation" "example" {
}
```
