...
func (c *BlockSchemaClient) List(ctx context.Context, blockTypeSlugs []uuid.UUIDs) ([]*api.BlockSchema, error) {
	filterQuery := &api.BlockSchemaFilter{}
	filterQuery.BlockSchemas.BlockTypeID.Any = blockTypeSlugs
